...
extern const char font7x5_ru[] =
{
	...
	0x1E, 0x21, 0x7F, 0x21, 0x1E,// Ô
	0x63, 0x14, 0x08, 0x14, 0x63,// X
	0x3F, 0x20, 0x20, 0x3F, 0x40,// Ö
	0x1F, 0x10, 0x10, 0x10, 0x7F,// ×
	0x7F, 0x40, 0x7F, 0x40, 0x7F,// Ø
	0x3F, 0x20, 0x3F, 0x20, 0x7F,// Ù
	0x01, 0x7F, 0x44, 0x44, 0x38,// Ú
	0x7F, 0x44, 0x7C, 0x00, 0x7F,// Û
	0x7F, 0x44, 0x44, 0x44, 0x38,// Ü
	0x22, 0x41, 0x49, 0x49, 0x3E,// Ý
	0x7F, 0x08, 0x7F, 0x41, 0x7F,// Þ
	0x46, 0x29, 0x19, 0x09, 0x7F,// ß


	0x20, 0x54, 0x54, 0x54, 0x78,// a
	0x3C, 0x4A, 0x4A, 0x4B, 0x30,// á
	0x7C, 0x54, 0x54, 0x58, 0x20,// â
	0x7C, 0x04, 0x04, 0x04, 0x00,// ã
	0x60, 0x38, 0x24, 0x3C, 0x60,// ä
	0x38, 0x54, 0x54, 0x54, 0x18,// e
	0x74, 0x08, 0x7C, 0x08, 0x74,// æ
	0x28, 0x44, 0x54, 0x54, 0x28,// ç
	0x7C, 0x20, 0x10, 0x08, 0x7C,// è
	0x7C, 0x21, 0x12, 0x09, 0x7C,// é
	0x00, 0x7C, 0x10, 0x28, 0x44,// ê
	0x40, 0x78, 0x04, 0x04, 0x7C,// ë
	...
	0x0C, 0x50, 0x50, 0x50, 0x3C,// y
	0x18, 0x24, 0x7C, 0x24, 0x18,// ô
	0x44, 0x28, 0x10, 0x28, 0x44,// õ
	0x3C, 0x20, 0x20, 0x3C, 0x40,// ö
	0x1C, 0x20, 0x20, 0x20, 0x7C,// ÷
	0x7C, 0x40, 0x7C, 0x40, 0x7C,// ø
	0x3C, 0x20, 0x3C, 0x20, 0x7C,// ù
	0x04, 0x7C, 0x48, 0x48, 0x30,// ú
	0x7C, 0x48, 0x48, 0x30, 0x7C,// û
	0x7C, 0x48, 0x48, 0x48, 0x30,// ü
	0x28, 0x44, 0x54, 0x54, 0x38,// ý
	0x7C, 0x38, 0x44, 0x44, 0x38,// þ
